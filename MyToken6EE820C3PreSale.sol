...
import "./MyToken6EE820C3.sol";

contract MyToken6EE820C3PreSale {
    MyToken6EE820C3 public token;
    ...
    function MyToken6EE820C3PreSale(
        MyToken6EE820C3 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken6EE820C3(_token);
